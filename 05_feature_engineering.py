"""
Feature engineering. Verbatim from original cell 19. NOT independently re-audited for stale column references beyond the ones already confirmed to route through the legacy alias layer (power_output, rotor_speed, generator_speed). Run the schema-audit prompt against this file before trusting it against a different generator config.
"""
