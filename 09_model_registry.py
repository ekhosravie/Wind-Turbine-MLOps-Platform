"""
Register the Champion model to the Unity Catalog Model Registry with the Champion alias. Verbatim from original cell 27. Uses the current UC registry API (mlflow.register_model + set_registered_model_alias), not the deprecated stages API - this part was already correct.
"""
