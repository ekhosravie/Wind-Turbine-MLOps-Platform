"""
Model comparison / Champion selection logic. Verbatim from original cell 25. This logic was independently checked and is correct: it gates on config.minimum_recall BEFORE ranking by PR-AUC, and explicitly prints NO QUALIFIED CHAMPION rather than silently promoting an unsafe model. Still relies on the notebook-global 'results' dict rather than a function argument - wrap it before calling from outside a notebook.
"""
