"""
Batch inference: score data with the Champion model, write predictions. Verbatim from original cell 29. Relies on notebook-global state (results, champion_name, test_df, X_test, id_cols).
"""
